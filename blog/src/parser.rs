...
pub fn markdown_to_html(
    ...
    let partial_js = fs::read_to_string("pages/blog.js").ok()?;
    let full_js = format!(
        r#"
        <script>
            {}
    ...
    let partial_css = fs::read_to_string("pages/blog.css").ok()?;
    let full_css = format!(
        r#"
        <style>
            {}
    ...
    let partial_head = fs::read_to_string("pages/blog.head").ok()?;
